 ...
 * @author ariel
 */
public class DilemaDoPrisioneiroMarcosPastor {
    ...
    public static void main(String[] args) {
        ...
        while (continuarEstrategia) {
            if (modoEstrategia == 3 || modoEstrategia == 4 || modoEstrategia == 5 || modoEstrategia == 6 || modoEstrategia == 7) {
                System.out.print("\nVejo que você escolheu a estratégia " + modoEstrategia + ", certo?\n"//DAR NOME AO TIPO DE ESTRATÉGIA.
        ...
        while (modoEstrategia == 3) {//3- Não Iterado (simples);
            if (modoTrair_Cooperar == 1) {
                ...
                System.out.println("Você escolheu '" + modoTrair_Cooperar + "' (trair). Seu parceiro decidiu " + comparsa + ".");
                return;
            }
            if (modoTrair_Cooperar == 2) {
                comparsa = (int) (1 + Math.random() * 2);
                System.out.println("Você escolheu '" + modoTrair_Cooperar + "' (cooperar). Seu parceiro decidiu " + comparsa + ".");
                return;
